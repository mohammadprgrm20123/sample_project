...
// in sample_project/test/auth/domain/usecase/login_usecase_test.dart.
...
class MockLoginRepository extends _i1.Mock implements _i3.LoginRepository {
  ...
  @override
  _i4.Future<_i2.Either<_i5.FailureEntity, void>> login(_i6.LoginDto? dto) =>
      (super.noSuchMethod(
        Invocation.method(
          #login,
          [dto],
        ),
        returnValue: _i4.Future<_i2.Either<_i5.FailureEntity, void>>.value(
            _FakeEither_0<_i5.FailureEntity, void>(
          this,
          Invocation.method(
            #login,
            [dto],
      ...
      ) as _i4.Future<_i2.Either<_i5.FailureEntity, void>>);
}
