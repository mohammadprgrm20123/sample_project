...
class EmailValidator {
  ...
  // returns false
  static bool _isAtom(final String c, final bool allowInternational) =>
      c.codeUnitAt(0) < 128
  ...
  // domainType is set to Alphabetic and the function returns true
  // Otherwise, the function returns false
  static bool _isDomain(final String c, final bool allowInternational) {
  ...
  static bool _isDomainStart(final String c, final bool allowInternational) {
    if (c.codeUnitAt(0) < 128) {
      if (_isLetter(c)) {
        _domainType = SubdomainType.Alphabetic;
        return true;
  ...
  static bool _skipAtom(final String text, final bool allowInternational) {
  ...
  static bool _skipSubDomain(final String text, final bool allowInternational) {
    final startIndex = _index;
  ...
  static bool _skipDomain(final String text, final bool allowTopLevelDomains,
  ...
  // otherwise the function returns false
  static bool _skipQuoted(final String text, final bool allowInternational) {
    var escaped = false;
  ...
  static bool validate(final String email,
      [final bool allowTopLevelDomains = false,
      final bool allowInternational = true]) {
    _index = 0;
